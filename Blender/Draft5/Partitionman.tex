...
\label{deriveorder}
\end{equation}
From Eq \ref{deriveorder}  it is straight forward to define the sum over $a_{K+k}$ in Eq \ref{deriveorder} as, 
\begin{equation}
\sum_{k=1}^{G(E_j)}a_{K+k} \equiv  G(E_j)<a_i>_{j} \;, 
\end{equation}
