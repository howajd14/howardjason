...
int main()
{
   ...
   {myNN.push_back(NN(1,20,2,5));
	   string filename = "FinalNN"; stringstream ss; ss << x; 
	   string holder; ss >> holder; filename = filename + holder; 
	   myNN[x-1].load_NN(filename); 
   } 
